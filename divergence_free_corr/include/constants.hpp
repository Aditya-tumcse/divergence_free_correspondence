...
const double SEARCH_RADIUS = 0.0576; // This value is to be adjusted accoring to the sampled points size
constexpr int NUMBER_OF_SAMPLE_POINTS = 500;
constexpr double SIGMA = 0.01;
constexpr int MAX_NUMBER_OF_VELOCITY_BASIS = 50;
const uint32_t MAX_NUMBER_OF_ITERS = 10; // 100
const uint32_t NUMBER_OF_TIME_STEPS = 100;
